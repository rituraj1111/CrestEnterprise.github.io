...
const Products = () => {
  ...
  const qualityFeatures = ["Premium Quality Manufacturing", "BPA-Free and Environment Friendly", "Superior Print Quality with Sharp Text", "Long-lasting Storage without Fading", "Consistent Roll Diameter and Length", "Dust-free and Smooth Surface Finish"];
  return <>
      <Helmet>
            ...
            {products.map((product, index) => {
              ...
              return <Card key={index} className="h-[700px] flex flex-col hover:shadow-medium transition-all duration-300 group cursor-pointer" onClick={() => handleProductClick(product)}>
                  ...
                  <CardContent className="flex-1 flex flex-col justify-between space-y-4">
                    <div className="space-y-4">
                      ...
                      <div>
                        ...
                        <div className="grid grid-cols-2 gap-1">
                          {product.features.map(feature => <div key={feature} className="flex items-center text-xs">
                      ...
                      <div>
                        ...
                        <div className="flex flex-wrap gap-1">
                          {product.applications.slice(0, 3).map(app => <Badge key={app} variant="outline" className="text-xs">
                              {app}
                            </Badge>)}
                        </div>
                      </div>
                    ...
                    <Button className="w-full bg-gradient-accent hover:opacity-90 mt-auto" onClick={e => {
                    e.stopPropagation();
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center mb-20">
            <div>
              ...
              <div className="space-y-3">
                {qualityFeatures.map((feature, index) => <div key={index} className="flex items-center">
