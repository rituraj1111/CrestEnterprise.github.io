...
const CTASection = () => {
  ...
  return <section className="py-20 bg-gradient-to-r from-primary/5 via-accent/5 to-primary/5">
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-12 max-w-2xl mx-auto">
          ...
          return <Card key={index} className="hover:shadow-medium transition-all duration-300 hover:-translate-y-1">
                <CardContent className="p-6 text-center">
                  ...
                  <Button onClick={option.onClick} variant={option.variant} className="w-full">
